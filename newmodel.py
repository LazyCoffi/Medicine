...
class (models.Model):
    ...
    员工姓名 = models.CharField(max_length=10)
...
class (models.Model):
    ...
    厂家登记机关 = models.CharField(max_length=20)
...
class (models.Model):
    ...
    零售价 = models.DecimalField(max_digits=20, decimal_places=4, blank=True, null=True)
    批发价 = models.DecimalField(max_digits=20, decimal_places=4, blank=True, null=True)
    厂家注册号 = models.ForeignKey(, models.DO_NOTHING, db_column='厂家注册号')
    产地 = models.CharField(max_length=20, blank=True, null=True)
    质量标准 = models.CharField(max_length=20, blank=True, null=True)
    医疗编号 = models.CharField(max_length=20, blank=True, null=True)
...
class (models.Model):
    药品编号 = models.OneToOneField(, models.DO_NOTHING, db_column='药品编号', primary_key=True)
...
class (models.Model):
    ...
    员工编号 = models.ForeignKey(, models.DO_NOTHING, db_column='员工编号')
...
class (models.Model):
    ...
    销售日期 = models.DateField()
    员工编号 = models.ForeignKey(, models.DO_NOTHING, db_column='员工编号')
    客户编号 = models.ForeignKey(, models.DO_NOTHING, db_column='客户编号')
    品种数量 = models.IntegerField()
...
class (models.Model):
    进货单号 = models.OneToOneField(, models.DO_NOTHING, db_column='进货单号', primary_key=True)
    药品编号 = models.ForeignKey(, models.DO_NOTHING, db_column='药品编号')
...
class (models.Model):
    销售单号 = models.OneToOneField(, models.DO_NOTHING, db_column='销售单号', primary_key=True)
    药品编号 = models.ForeignKey(, models.DO_NOTHING, db_column='药品编号')
